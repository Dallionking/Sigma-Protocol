...
// Build for Codex platform — delegates to cli/lib/platform/codex.js
// Kept as a thin wrapper for consistency with other inline builders
async function buildCodex(targetDir, modules, spinner) {
  const { buildCodex: buildCodexImpl } = await import("./lib/platform/codex.js");
  return buildCodexImpl(targetDir, modules, spinner);
}
