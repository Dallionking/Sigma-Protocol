...
- [ ] HITL checkpoint: Present research findings
...
- [ ] HITL checkpoint: Present architecture approach
- [ ] Wait for user approval before proceeding
...
- [ ] HITL checkpoint: Present performance strategy
- [ ] Wait for user approval before proceeding
...
## Phase 0 — Import Step 1 Decisions (NEW)
...
## Phase H — Assemble the Technical Architecture (paste back + write files)
