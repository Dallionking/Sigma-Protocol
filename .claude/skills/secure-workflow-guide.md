---
description: Guide you through Trail of Bits' 5-step secure development workflow.
  ...
  for fuzzing/verification, and reviews manual security areas. (project, gitignored)
