...
- [ ] Font choice evokes intended brand emotion
- [ ] Line heights optimize for readability (1.5 body, 1.2 headings)
- [ ] Scale is mathematical (modular scale ratio)
- [ ] Weights are purposeful (not random bold)
...
**Color Quality Gate:**
- [ ] Primary color reflects brand personality
- [ ] Semantic colors are intuitive (green=good, red=bad)
- [ ] Neutrals have subtle warmth or coolness (not pure gray)
...
- [ ] HITL checkpoint: Present color system
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present typography system
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present spacing & layout
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present component library
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present motion system
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present design tokens
- [ ] Wait for approval
...
**Scale to Generate:**
- primary-50: [Lightest tint - calculate]
- primary-100: [Calculate]
- primary-200: [Calculate]
- primary-300: [Calculate]
- primary-400: [Calculate]
- primary-500: `#[HEX]` (wireframe base)
- primary-600: [Calculate]
- primary-700: [Calculate]
- primary-800: [Calculate]
- primary-900: [Darkest shade - calculate]
...
### Font Families
- **Display/Heading:** [Font from wireframes]
- **Body:** [Font from wireframes]
- **Monospace:** [Font from wireframes or default]

### Type Scale (From Wireframes)
**Sizes Found:**
- [Size 1]: [Value]px
- [Size 2]: [Value]px
- [Size 3]: [Value]px
...
**Scale to Generate:**
- Display Large: [Expand from wireframes]
- Display Medium: [Expand from wireframes]
- Heading 1-6: [Map from wireframe sizes]
- Body Large/Medium/Small: [Map from wireframe sizes]
- Caption: [Expand from wireframes]
...
### Button
**Variants Found:** [List from wireframes]
**Sizes Found:** [List from wireframes]
**States Found:** [List from wireframes]

**Tokens to Define:**
- button-height-sm: [Value]px
- button-height-md: [Value]px
- button-height-lg: [Value]px
- button-padding-x: [Value]px
- button-padding-y: [Value]px
...
## Phase I — Assemble the Design System (paste back + write files)
