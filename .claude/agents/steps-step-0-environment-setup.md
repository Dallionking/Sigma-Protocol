...
- [ ] HITL checkpoint: Present system status
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present MCP status
- [ ] Wait for approval
...
#### **4. Perplexity Ask MCP**

**When you need it:**
- Backup research tool
