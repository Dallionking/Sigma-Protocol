...
./scripts/ralph/sigma-ralph.sh . docs/ralph/implementation/swarm-1/prd.json claude-code
./scripts/ralph/sigma-ralph.sh . docs/ralph/implementation/swarm-2/prd.json claude-code
# etc.
```
