...
export default function EmptyAchievementsScreen() {
  ...
  return (
    <GradientBackground dim>
      ...
      >
        ...
        >
          {/* Golden accent glow for achievements */}
          ...
          <GlassPanel style={styles.card} intensity={40}>
            ...
            >
              ...
              <View style={styles.iconCircle}>
                <Trophy size={28} color={colors.accent[400]} />
              </View>
            </MotiView>
            ...
            >
              <Text style={styles.title}>No achievements yet</Text>
            ...
            >
              <Text style={styles.hintText}>
                Your first badge is just a lesson away
              </Text>
            </MotiView>
