...
export default function EmptyBookingsScreen() {
  ...
  return (
    <GradientBackground dim>
      ...
      >
        ...
        >
          {/* Warm glow for encouraging state */}
          ...
          <GlassPanel style={styles.card} intensity={40}>
            ...
            >
              <Text style={styles.title}>No sessions booked</Text>
            ...
            >
              <Text style={styles.hintText}>
                Live practice accelerates learning
              </Text>
            </MotiView>
