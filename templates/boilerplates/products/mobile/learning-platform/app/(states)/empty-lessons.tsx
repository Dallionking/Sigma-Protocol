...
export default function EmptyLessonsScreen() {
  ...
  return (
    <GradientBackground dim>
      ...
      >
        ...
        >
          {/* Warm teal glow for encouraging state */}
          ...
          <GlassPanel style={styles.card} intensity={40}>
            ...
            >
              ...
              <View style={styles.iconCircle}>
                <BookOpen size={28} color={colors.secondary[400]} />
              </View>
            </MotiView>
            ...
            >
              <Text style={styles.title}>No lessons yet</Text>
