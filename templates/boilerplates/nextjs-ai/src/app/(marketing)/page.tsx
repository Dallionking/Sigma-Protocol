        ...
        <div className="container relative px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl">
              Production-ready boilerplate with authentication, payments, AI integration, 
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group relative rounded-2xl border p-8 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/5 transition-all"
              >
          ...
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-purple-600 to-blue-600 p-12 md:p-20">
            <div className="relative z-10 text-center text-white max-w-2xl mx-auto">
              ...
              <p className="text-lg opacity-90 mb-8">
                Join 500+ developers who are building and shipping with SSS SaaS.
              </p>
              <Link href="/signup">
