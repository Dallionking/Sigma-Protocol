...
**Prompt:** "Documenting boilerplate extensions. Reply `confirm extend` to continue, or `full spec` to document everything from scratch."
...
- [ ] HITL checkpoint: Present executive summary
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present system architecture
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present complete tech stack
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present database design
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present API design
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present security architecture
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present frontend specs
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present backend specs
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present infrastructure
- [ ] Wait for approval
...
- [ ] HITL checkpoint: Present testing strategy
- [ ] Wait for approval
